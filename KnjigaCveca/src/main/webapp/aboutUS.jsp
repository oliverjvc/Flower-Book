...
<head>
    ...
    <title>About Us - Your Flower Shop</title>
    <!-- Add your CSS stylesheets or scripts here -->
</head>
<body>
    ...
    <div class="container mt-4">
        <div class="row">
            ...
            <!-- Add a sidebar or additional content as needed -->
        </div>
    </div>

    <!-- Add your footer or other common elements here -->

    <!-- Add your Bootstrap JS and other scripts as needed -->
